Detect and verify the use of parameter type declarations in function declarations.Parameter type declarations - class/interface names only - is available since PHP 5.0.
